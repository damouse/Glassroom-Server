...
<tt>ssh -2 -i aws_key.pem ubuntu@ec2-54-186-197-24.us-west-2.compute.amazonaws.com</tt>

The site is publically visible at the URL <tt>ec2-54-186-197-24.us-west-2.compute.amazonaws.com/</tt>
...
GET <tt>/api/login?user_email=test@test.com&user_password=12345678</tt>
...
Sample Response:
{
  ...
  "user": {
    ...
    "updated_at": "2014-05-03T02:13:42.604Z",
    "email": "test@test.com",
...
POST <tt>/api/auth?user_email=EMAIL&user_token=TOKEN</tt>

Sample Body:
{
  "user_id": 1,
  "user_token": "5cpMzSL8XsxhV4WBbSnb"
}
...
POST <tt>/api/create_lecture</tt>

Sample Body:
{
  "user_id": 2,
  "user_token": "RcxtzLtJhyxTPwWRHgik"
}

Sample Response:
{
  "response": "saved new lecture",
  "status": "success",
  "lecture": {
    "id": 7,
    "name": "New Lecture 7",
    "subject_id": 1,
    "created_at": "2014-05-03T02:13:42.619Z",
    "updated_at": "2014-05-03T02:13:42.627Z"
  }
}
...
Body:   
{
    ...
    "name": "test1.jpg",
    "user_id": 2,
    "user_token": "CFpsRE9z_ndxtwc3cKs9",
